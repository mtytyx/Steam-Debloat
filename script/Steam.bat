...
set "OPTS=-noverifyfiles -norepairfiles -noshaders -nocrashdialog -single_core -tcp -clearbeta -netbuffer 262144 -no-cef-sandbox -vrdisable -no-shared-textures -disable-font-subpixel-positioning -threads 2"
